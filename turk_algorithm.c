...
static void	get_rotation_costs(t_stack *stack, int target_index,
...
static void	apply_rotations(t_stack *stack, char stack_name,
		int count, int up_direction)
{
	while (count-- > 0)
	{
...
static int	first_steps(t_stack *a, t_stack *b)
{
...
void	turk_algorithm(t_stack *a, t_stack *b)
{
	...
	while (b->top >= 0)
	{
		target_a = find_position_in_a(a, b->data[b->top]);
